...
namespace CognitiveSearch.UI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Search([FromQuery]string q, [FromQuery]string facets = "", [FromQuery]int page = 1, [FromQuery] bool showPII = false, [FromQuery] bool simpleText = false)
        {
            // Split the facets.
        ...
        public SearchResultViewModel SearchView([FromForm]SearchOptions searchParams)
        {
            ...
            var viewModel = new SearchResultViewModel
            {
                ...
                showPII = searchParams.showPII,
                simpleText = searchParams.simpleText,
                ...
                textAnalyticContentAzureFunction = _configuration.GetSection("textAnalyticContentAzureFunction")?.Value,
