...
$('#btnShowPII').click(function () {

    showPII = true;
  
    $('#btnShowPII').css("display", "none");
    $('#btnHidePII').show();
    Search();
    
});

$('#btnHidePII').click(function () {

    showPII = false;

    $('#btnHidePII').css("display", "none");
    $('#btnShowPII').show();
    Search();
...
$('#btnSimpleText').click(function () {
    ...
    $('#btnSimpleText').css("display", "none");
    $('#btnHideSimple').show();
    Search();

});

$('#btnHideSimple').click(function () {

    simpleText = false;

    $('#btnHideSimple').css("display", "none");
    $('#btnSimpleText').show();
    Search();
...
function Update(viewModel) {
    ...
    //Results List
    UpdateResults(data, showPII, simpleText);

    //display Marked Up Data
    if (simpleText == false) {
        DisplayMarkedUpText(data, showPII)
    }
